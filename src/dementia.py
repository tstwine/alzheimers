...
"Types_of_Alzheimer's":"""Mild Alzheimer's Disease people experience greater memory loss and other cognitive difficulties. Problems can 
	...
	"treatments":"""No treatment is available to slow or stop Alzheimer’s disease. The U.S. Food and Drug Administration has pproved five drugs that 
					...
					Researchers around world are studying dozens of treatment strategies that may have the potential to change the course of the disease."""
},
...
Parkinsons = {
	...
	"symptons":"""  Changes in memory, concentration and judgment, trouble interpreting visual information, muffled speech, visual hallucinations,
...
Frontotemporal_Dementia(FTD) = {
	...
	"Types_of_FTD":"""Behavior variant frontotemporal dementia (bvFTD). This condition is characterized by prominent changes in personality, interpersonal 
				    ...
				    In bvFTD, the nerve cell loss is most prominent in areas that control conduct, judgment, empathy and foresight, among other abilities. 
				   	...
				   	writing and comprehension. PPA normally comes on in midlife, before age 65, but can occur in late life also. The two most distinctive forms of
				   	PPA are the semantic variant of PPA, individuals lose the ability to understand or formulate words in a spoken sentence and nonfluent/agrammatic 
				    variant of PPA, a person’s speaking is very hesitant, labored or ungrammatical. There are three disorders that are a part of the frontotemporal
				    degeneration spectrum that produce changes in muscle or motor functions with or without behavior (bvFTD) or language (PPA) problems. 
...
Creutzfeldt_Jakob_Disease(CJD) = {
		"definition":"""Creutzfeldt-Jakob disease (CJD) is the most common human form of a group of rare, fatal brain disorders known as prion diseases.
		 ...
		 "symptons":""""depression, agitation, apathy and mood swings, rapidly worsening confusion, disorientation, and problems with memory, thinking, 
...
Normal_Pressure_Hydrocephalus(NPH) = {
   "definition":"""Normal Pressure Hydrocephalus is a brain disorder in which excess cerebrospinal fluid Normal pressure hydrocephalus is a 
	...
	"symptons:""""Difficulty walking that's sometimes compared to the way a person walks "on a boat," with the body bent forward, 
 	...
 	"causes":"""  Normal Pressure Hydrocephalus may be caused by other brain disorders such as hemorrhages, infections or inflammation. But in most cases, 
			   	  the fluid buildup happens for unknown reasons.""", 
